package com.example.weathermateapp.Activites
...
import com.example.weathermateapp.Models.WeatherModel
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.etCitysearch.setOnEditorActionListener { textView, i, keyEvent ->

            if (i==EditorInfo.IME_ACTION_SEARCH){

                getCityWeather(binding.etCitysearch.text.toString())
    ...
    private fun setData(body:WeatherModel){
        ...
        binding.apply {
            ...
            tempFaValue.text=""+(k2c(body.main.temp).times(1.8)).plus(32)
                .roundToInt()+"°"

            etCitysearch.setText(body.name)
        ...
        binding.apply {
            ...
            when (id) {
                ...
                //unknown
                    ...
                    mainLayout.background=ContextCompat
                        .getDrawable(this@MainActivity, R.drawable.ic_unknown)
